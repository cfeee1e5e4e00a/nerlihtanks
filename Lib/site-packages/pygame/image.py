...
def load_basic(file, namehint=''):
    ...
    _img = window.Image.new()
    _img.src = file
    # browser.console.dir(_img)
    ...
    def img_onload(*args):
        ...
        # browser.console.dir(this)
        # print(type(this.width))
        # print(vars(this)['width'])
        # print(this['width'])
        # browser.timer.set_timeout(lambda a: print('wtf', a, vars(a)), 1000, this)
        this.canvas.width = vars(this)['width']
        this.canvas.height = vars(this)['height']
